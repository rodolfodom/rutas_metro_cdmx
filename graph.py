...
linea_1 = {
    ...
    "Zaragoza": [("Gomez Farías", 762), ("Pantitlán-1", 1320)],
    "Gomez Farías": [("Boulevard Puerto Aéreo", 595), ("Zaragoza", 762)],
    "Boulevard Puerto Aéreo": [("Balbuena", 595), ("Gomez Farías", 595)],
...
linea_12 = {
    ...
    "Periférico Oriente": [("Calle 11", 1772), ("Tezonco", 1545)],
    "Calle 11": [("Lomas Estrella", 1233), ("Periférico Oriente", 1772)],
    "Lomas Estrella": [("San Andrés Tomatlán", 1331), ("Calle 11", 1233)],
    "San Andrés Tomatlán": [("Culhuacán", 617), ("Lomas Estrella", 1331)],
    "Culhuacán": [("Atlalilco-12", 1603), ("San Andrés Tomatlán", 617)],
    "Atlalilco-12": [("Mexicaltzingo", 997), ("Atlalilco-8", 300), ("Culhuacán", 1603)],
    "Mexicaltzingo": [("Ermita-12", 1705), ("Atlalilco-12", 997)],
    "Ermita-12": [("Eje Central", 770), ("Ermita-2", 300), ("Mexicaltzingo", 1705)],
    "Eje Central": [("Parque de los Venados", 1344), ("Ermita-12", 770)],
    "Parque de los Venados": [("Zapata-12", 983), ("Eje Central", 1344)],
    "Zapata-12": [("Hospital 20 de Noviembre", 1640), ("Zapata-3", 300), ("Parque de los Venados", 983)],
    "Hospital 20 de Noviembre": [("Insurgentes Sur", 1328), ("Zapata-12", 1640)],
    "Insurgentes Sur": [("Mixcoac-12", 865), ("Hospital 20 de Noviembre", 1328)],
    "Mixcoac-12": [("Mixcoac-7", 300), ("Insurgentes Sur", 865)],
}
